...
//	{
//		private Mock<IRepositoryService> _repositoryMock;
...
//			_repositoryMock = new Mock<IRepositoryService>();
//			_blobServiceClientMock = new Mock<BlobServiceClient>();

//			_repositoryMock.Setup(x => x.AllReadOnly<Plant>())
//				.Returns(plants.AsQueryable().BuildMock());
...
//		[Test]
//		public async Task Test_ExistsAsync_ReturnsTrue_WhenId_1_Is_Called()
//		{
//			var resultTask = await _plantService.ExistsAsync(1);
//			var falseResult = await _plantService.ExistsAsync(0);

//			Assert.That(resultTask, Is.EqualTo(true));
